...
$lang = array_merge($lang, array(
	...
	'PBWOW_VERSION_CHECK'				=> 'Verificación de versión de PBWoW',
	'PBWOW_LATEST_VERSION'				=> 'Última versión',
	'PBWOW_EXT_VERSION'					=> 'Versión de la extensión',
	'PBWOW_STYLE_VERSION'				=> 'Versión del estilo',
	'PBWOW_LATEST_STYLE_VERSION'		=> 'Última versión del estilo',
	'PBWOW_CHECK_UPDATE'				=> 'Visite <a href="https://www.avathar.be/forum/index.php">avathar.be</a> para comprobar si hay actualizaciones disponibles.',
	...
	'PBWOW_DONATE_SHORT'				=> 'Realizar una donación a PBWoW',
	...
	'PBWOW_AVATARS'						=> 'Avatares de juegos',
	'PBWOW_AVATARS_ENABLE'				=> 'Activar avatares de juegos (e iconos) en todo el foro',
	'PBWOW_AVATARS_ENABLE_EXPLAIN'		=> 'Si se activa, PBWoW mostrará un avatar de juego generado a partir de los campos de bbGuild si el usuario no tiene un avatar personalizado configurado.',
	'PBWOW_SMALLRANKS_ENABLE'			=> 'Usar imágenes de rango pequeñas',
	'PBWOW_SMALLRANKS_ENABLE_EXPLAIN'	=> 'Active esta opción si desea utilizar imágenes de rango pequeñas que se superponen al avatar. No active esta opción si está utilizando imágenes de rango más grandes.',
	...
	'PBWOW_VIDEOBG_ENABLE_EXPLAIN'		=> 'Algunos estilos de PBWoW admiten fondos de vídeo animados especiales (no todos). Puede activarlos para obtener un efecto atractivo, o desactivarlos para ahorrar ancho de banda (o si tiene problemas).',
	...
	'PBWOW_ADS_INDEX_CODE_EXPLAIN'		=> 'Este bloque es adecuado para publicidad con un <u>ancho</u> de: <b>300px</b>.<br />Si desea usar o cambiar estilos CSS personalizados, añádalos a <samp>ext/paybas/pbwowext/styles/pbwow3/theme/pbwowext.css</samp>',
));
